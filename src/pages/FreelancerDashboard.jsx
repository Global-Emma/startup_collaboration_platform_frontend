  ...
  return (
    <section className="dashboard">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : "collapsed"}`}>
        ...
        <h2 className="logo">{sidebarOpen ? "VentureLink" : "VL"}</h2>
      ...
      {/* 🔔 NOTIFICATIONS */}
      <div className={`notifications ${notificationsOpen ? "open" : "closed"}`}>
        ...
        >
          <h4>Notifications</h4>
          {notificationsOpen ? <ChevronDown size={16} /> : <ChevronUp size={16} />}
        </div>
